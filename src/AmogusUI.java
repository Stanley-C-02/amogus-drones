...
public class AmogusUI {
	...
	private static void reInitAll(Amadrone[] drones, House[] houses, ChargingStation chargers[], PackageSM[] packages) {
		...
		drones[0].getBattery().setAvailable(10);
		drones[0].getBattery().setMaxCapacity(15);
		drones[0].getGps().setId(0);
		drones[0].getGps().setName("Advanced GPS");
		drones[0].getGps().setPower(200);
		drones[0].getMotor().setId(0);
		drones[0].getMotor().setName("GM3506");
		drones[0].getMotor().setPower(1200);
		drones[0].getMotor().setSpeed(12);
		...
		drones[1].getBattery().setAvailable(5);
		drones[1].getBattery().setMaxCapacity(5);
		drones[1].getGps().setId(1);
		drones[1].getGps().setName("Standard GPS");
		drones[1].getGps().setPower(75);
		drones[1].getMotor().setId(1);
		drones[1].getMotor().setName("GM2804");
		drones[1].getMotor().setPower(750);
		drones[1].getMotor().setSpeed(20);
		drones[1].getMotor().setMax_payload(300);
		drones[2].setId(2);
		...
		drones[2].getBattery().setAvailable(30);
		drones[2].getBattery().setMaxCapacity(30);
		drones[2].getGps().setId(2);
		drones[2].getGps().setName("Standard GPS");
		drones[2].getGps().setPower(75);
		drones[2].getMotor().setId(2);
		drones[2].getMotor().setName("A2212");
		drones[2].getMotor().setPower(2500);
		drones[2].getMotor().setSpeed(10);
